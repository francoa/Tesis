...
\begin{figure}[H]
  \centering
  \includegraphics[width=10cm]{Figures/spheres.png}
  \caption{Imágen de las nanopartículas esféricas de material.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=10cm]{Figures/spheres3.png}
...
\begin{figure}[H]
  \centering
  \begin{tabular}{c}
    \subfloat[Porosidad 13\%, sin deformación]{\includegraphics[width=8cm]{Figures/13_0strain.png}} \\
    \subfloat[Porosidad 13\%, deformación 5\%]{\includegraphics[width=8cm]{Figures/13_5strain_comp.png}}
    \subfloat[Porosidad 13\%, deformación 12\%]{\includegraphics[width=8cm]{Figures/13_12strain_comp.png}}\\
  \end{tabular}
...
\begin{figure}[H]
  ...
  \begin{tabular}{c}
    \subfloat[Porosidad 13\%, sin deformación]{\includegraphics[width=8cm]{Figures/13_0strain.png}} \\
    \subfloat[Porosidad 13\%, deformación 5\%]{\includegraphics[width=8cm]{Figures/13_6strain_tens.png}}
    \subfloat[Porosidad 13\%, deformación 12\%]{\includegraphics[width=8cm]{Figures/13_20strain_tens.png}}\\
  \end{tabular}
  \caption{Coloreado de una sección de la muestra con
