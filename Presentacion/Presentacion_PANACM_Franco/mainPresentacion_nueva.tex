...
\author[Ardiani (francoamg@gmail.com)]{Franco Ardiani$^a$ (francoamg@gmail.com), Andrés A. Manelli$^a$, Carlos J. Ruestes$^{b,c}$, Claudio A. Careglio$^{a}$ and Eduardo M. Bringa$^{b,c}$}
\institute[UNCUYO]{$^a$Facultad de Ingeniería, Universidad Nacional de Cuyo\\$^b$FCEN, Universidad Nacional de Cuyo\\$^c$CONICET}
\date{\today}
...
\begin{frame}
    ...
    \begin{enumerate}
        ...
        \begin{textblock*}{3cm}(2.5cm,6.5cm) % {block width} (coords)
            \includegraphics[width=3cm]{spheres2.png}
        \end{textblock*}
        \begin{textblock*}{3cm}(7cm,6.5cm) % {block width} (coords)
            \includegraphics[width=3cm]{spheres3.png}
        \end{textblock*}
    \end{enumerate}
\end{frame}
...
\begin{frame}
    ...
    \begin{textblock*}{7.5cm}(0.3cm,2cm) % {block width} (coords)
        \includegraphics[width=7.5cm]{Pzz_strain_comp_dash.eps}
    \end{textblock*}
...
\begin{frame}
    ...
    \begin{textblock*}{6.5cm}(0.4cm,2cm) % {block width} (coords)
        \includegraphics[width=4cm]{13_0strain.png}
        \includegraphics[width=4cm]{13_5strain_comp.png}
        \includegraphics[width=4cm]{13_12strain_comp.png}
    \end{textblock*}
...
\begin{frame}
    ...
    \framesubtitle{Compression}
    \begin{textblock*}{7.5cm}(0.3cm,2cm) % {block width} (coords)
        \includegraphics[width=7.5cm]{tipe3_strain_comp.eps}
    \end{textblock*}
...
\begin{frame}
    ...
    \begin{textblock*}{7.5cm}(0.3cm,2cm) % {block width} (coords)
        \includegraphics[width=7.5cm]{Pzz_strain_tens.eps}
    \end{textblock*}
    \begin{textblock*}{4cm}(8cm,2.2cm) % {block width} (coords)
        \includegraphics[width=4cm]{13_20strain_tens.png}\\
        \centering
...
\begin{frame}
    ...
    \begin{textblock*}{6.5cm}(0.4cm,2cm) % {block width} (coords)
        \includegraphics[width=4cm]{13_0strain.png}
        \includegraphics[width=4cm]{13_6strain_tens.png}
        \includegraphics[width=4cm]{13_20strain_tens_2.png}
    \end{textblock*}
...
\begin{frame}
    ...
    \framesubtitle{Tension}
    \begin{textblock*}{7.5cm}(0.3cm,2cm) % {block width} (coords)
        \includegraphics[width=7.5cm]{tipe3_strain_tens.eps}
    \end{textblock*}
