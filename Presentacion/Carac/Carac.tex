...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Muestra: Cu$_{46}$Zr$_{54}$, descripta por Arman \textit{et al}., 2010.
        \begin{itemize}
	  \item 160k \'atomos.
...
\begin{frame}
 ...
 \begin{textblock*}{4.5cm}(8cm,2.5cm)
      Expresi\'on adaptada de Cheng \textit{et al}. (2011) :\\
...
\begin{frame}
  ...
  \begin{textblock*}{9cm}(0cm,7.7cm)
   \centering
   \small{Son similares a las de nanoalambres de vidrios met\'alicos vistas en Xiao \textit{et al}. (2012).\\}
  \end{textblock*}
