...
\begin{columns}
  \begin{column}{0.48\paperwidth}
    ...
    \centering
    \begin{block}{Vidrio}
      \centering Sólido con estructura amorfa (\scriptsize{Sílice - SiO$_{2}$}\normalsize{)}
...
\ventaja{1}{{\begin{itemize}
             \item La ausencia de bordes de granos le otorga una gran resistencia a la corrosi\'on
            \end{itemize}
            }}
...
\begin{frame}
 ...
 \vspace{-0.15cm}
 \begin{block}{}
    \textit{Te\'oricamente, todo l\'iquido podr\'ia convertirse en vidrio a velocidades de enfriamiento suficientemente altas y temperaturas suficientemente bajas evitando el proceso de cristalizaci\'on} (Turnbull \textit{et al}, 1961)
 \end{block}
 ...
 \begin{textblock*}{10cm}(1.4cm,4.9cm)
  \begin{columns}
	...
	Los vidrios met\'alicos volum\'etricos, o \textit{Bulk Metallic Glasses} en ingl\'es, tienen una secci\'on transversal considerable.
    \end{alertblock}
    \end{column}
  \end{columns}
 \end{textblock*}
 \begin{textblock*}{12.6cm}(0.5cm,8.8cm)
  \scriptsize{Turnbull, D. and Cohen, M., \textit{J. Chem. Phys.}, \textbf{34(1)}, 120-125 (1961)}\\
  \scriptsize{Suryanarayana, C. and Inoue, A., \textit{Bulk Metallic Glasses}, CRC Press, (2011)}
  \end{textblock*}
\end{frame}
...
\begin{frame}
 ...
 \begin{textblock*}{11.8cm}(0.5cm,1.8cm)
  ...
  El crecimiento de estas bandas puede causar la fractura fr\'agil del material (Schuh \textit{et al}, 2007).
  \end{block}
 \end{textblock*}
 \vspace{-0.7cm}
...
\begin{textblock*}{\textwidth}(1cm,8.2cm)
 \centering
 \scriptsize{Muestra de BMG bajo tracci\'on uniaxial. Adaptado de Albe \textit{et al}, 2013}
\end{textblock*}
...
\begin{frame}
 ...
 \begin{textblock*}{12.6cm}(1.6cm,3cm)
  ...
  \end{textblock*}
  \only<3>{
    \begin{textblock*}{12.6cm}(0cm,3cm)
  \begin{figure}
  \centering
  \begin{tabularx}{\textwidth}{ccc}
	...
	\includegraphics[height=3cm]{Cap_1/BMG-blade.png}}
      ...
      \hspace{0.5cm}
      \subfloat[]{
	\includegraphics[height=3cm]{Presentacion/blades.png}}
  \end{tabularx}
  \end{figure}
  \end{textblock*}
  }
  
  \begin{textblock*}{12.6cm}(0.5cm,7.6cm)
  \begin{flushleft}
	\scriptsize{Kakiuchi, H. \textit{et al}., \textit{Mater. Trans.}, \textbf{42}, 678 (2001)}\\         
	\scriptsize{Schroers, J. \textit{et al}., \textit{Mater. Sci. Eng. A.}, \textbf{898}, 449-451 (2007)}\\
	\scriptsize{J. A. Horton1 and D. E. Parsell, University of Mississippi Medical Center}
  \end{flushleft}
  \end{textblock*}
\end{frame}
...
\begin{itemize}
 ...
 \end{itemize}
 \vspace{0.3cm}
 \item Investigar los efectos de cambios estructurales sobre las propiedades mec\'anicas y de qué manera esto ayuda a controlar las bandas de corte.
 \begin{itemize}
...
\begin{frame}
 ...
 \begin{figure}
  \centering
  \includegraphics[width=9cm]{Presentacion/multiescala.png}
 \end{figure}
  \begin{textblock*}{12.6cm}(0.5cm,8.8cm)
    \scriptsize{NASA, \textit{Modeling Materials: Design for Planetary Entry, Electric Aircraft, and Beyond}}\\
    \scriptsize{The George Washington University}
  \end{textblock*}
\end{frame}
...
\begin{frame}
 ...
 \begin{block}{Simulaciones Din\'amica Molecular (MD)}
  Resuelve ecuaciones de Newton para un sistema de N átomos que interact\'uan seg\'un una funci\'on potencial
 \end{block}
 \begin{textblock*}{12cm}(1.1cm,4.9cm)
  ...
  \begin{enumerate}
   ...
   \item Análisis: visual, atómico, termodinámico.
