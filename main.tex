...
En este trabajo se presentan experimentos numéricos respecto al comportamiento de vidrios metálicos. En una primera instancia, se analiza una matriz amorfa bajo diferentes condiciones de carga y temperatura. En una segunda instancia, se investigan los dos casos de composición modificada nombrados anteriormente: agregado de inclusiones para el caso particular de cobre cristalino con estructura de cubo centrada en las caras (FCC); y el sinterizado de un vidrio metálico a partir de nanopartículas de BMG, lo cual resulta en muestras con cierta porosidad.
