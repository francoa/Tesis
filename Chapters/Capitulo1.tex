...
\begin{figure}[h!]
 ...
 \caption[Material compuesto]{Esquema general de un material compuesto (adaptado del sitio web de \href{http://www.alustrong.com}{ALUSTRONG}).}
...
Gran pérdida de ductilidad ante la aparición de bandas de corte (véase \sref{S1_1_3}). El recocido (annealing en inglés) lo vuelve frágil. \\ \hline 
...
La mecánica de cavitación es estudiada por diversos autores describiendo la nucleación y crecimiento de los poros como desencadenantes de las fallas en MGs \citep{Huang13, guan13}. Gao \citep{Gao14} modela y analiza las interfaces amorfo-cristalinas en profundidad con un enfoque en describir los polyhedros de Voronoi como indicadores del ordenamiento atómico local.
