...
\caption{MSD para inclusión de Cu FCC a diferentes temperaturas}
\label{C4:fg:msd_Cu}
\end{figure}
...
\caption{Tensión de vonMises vs deformación para el BMG bajo esfuerzo uniaxial de tracción sin inclusión (línea punteada) y una inclusión (línea sólida)}
...
\caption{Tensión de vonMises vs deformación para el BMG bajo esfuerzo uniaxial de compresión sin inclusión (línea punteada) y una inclusión (línea sólida)}
...
\caption{Imágenes de la muestra bajo tracción a ciertas deformaciones a 10 K (la inclusión se señala en la primer imagen). El color representa la deformación cortante atómica.}
...
\caption{Imágenes de la muestra bajo compresión a ciertas deformaciones a 10 K (la inclusión se señala en la primer imagen). El color representa la deformación cortante atómica.}
...
\caption{Fracción de icosaedros bajo tracción y compresión a 10 K. La línea punteada representa la muestra original.}
