...
\cambio{El siguiente párrafo se agregó:}
...
\caption[Inclusión de Cu-FCC bajo tracción a 10K]{\cambio{Coloreado de una sección de la muestra con inclusión de Cu-FCC bajo tracción a 10K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.66 \%, 16.68 \% y 16.70 \%.}}
...
\caption[Inclusión de Cu-FCC bajo tracción a 200K]{\cambio{Coloreado de una sección de la muestra con inclusión de Cu-FCC bajo tracción a 200K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.46 \%, 16.48 \% y 16.50 \%.}}
...
\caption[Inclusión de Cu-FCC bajo tracción a 400K]{\cambio{Coloreado de una sección de la muestra con inclusión de Cu-FCC bajo tracción a 400K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.62 \%, 16.64 \% y 16.66 \%.}}
...
\caption[Inclusión de Cu-FCC bajo compresión a 10K]{\cambio{Coloreado de una sección de la muestra con inclusión de Cu-FCC bajo compresión a 10K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.74 \%, 16.86 \% y 16.92 \%.}}
...
\caption[Inclusión de Cu-FCC bajo compresión a 200K]{\cambio{Coloreado de una sección de la muestra con inclusión de Cu-FCC bajo compresión a 200K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.74 \%, 16.86 \% y 16.92 \%.}}
...
\caption[Inclusión de Cu-FCC bajo compresión a 300K]{\cambio{Coloreado de una sección de la muestra con inclusión de Cu-FCC bajo compresión a 300K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.74 \%, 16.86 \% y 16.92 \%.}}
...
\caption[Inclusión de CuZr-B2 bajo tracción a 10K]{\cambio{Coloreado de una sección de la muestra con inclusión de CuZr-B2 bajo tracción a 10K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.66 \%, 16.68 \% y 16.70 \%.}}
...
\caption[Inclusión de CuZr-B2 bajo tracción a 200K]{\cambio{Coloreado de una sección de la muestra con inclusión de CuZr-B2 bajo tracción a 200K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.56 \%, 16.58 \% y 16.60 \%.}}
...
\caption[Inclusión de CuZr-B2 bajo tracción a 400K]{\cambio{Coloreado de una sección de la muestra con inclusión de CuZr-B2 bajo tracción a 400K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.58 \%, 16.60 \% y 16.62 \%.}}
...
\caption[Inclusión de CuZr-B2 bajo compresión a 10K]{\cambio{Coloreado de una sección de la muestra con inclusión de CuZr-B2 bajo compresión a 10K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.74 \%, 16.86 \% y 16.92 \%.}}
...
\caption[Inclusión de CuZr-B2 bajo compresión a 200K]{\cambio{Coloreado de una sección de la muestra con inclusión de CuZr-B2 bajo compresión a 200K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.74 \%, 16.86 \% y 16.92 \%.}}
...
\caption[Inclusión de CuZr-B2 bajo compresión a 400K]{\cambio{Coloreado de una sección de la muestra con inclusión de CuZr-B2 bajo compresión a 400K según deformación cortante. De izquierda a derecha: $\epsilon$ = 16.74 \%, 16.86 \% y 16.92 \%.}}
