...
\begin{table}[htp]
\caption{Volúmenes y densidades iniciales a diferentes temperaturas simuladas.}
\begin{center}
\begin{tabular}{*{3}{c}}
...
\caption{Curvas de esfuerzo-deformación a diferentes temperaturas. Bajo tracción existen grandes fluctuaciones del esfuerzo que comienzan cuando se nuclea un poro a aproximadamente 15\% de deformación.}
...
\caption{Nucleación de un poro bajo tracción a 900 K. (a) $\epsilon$ = 0.137 (b) $\epsilon$ = 0.141 (c) $\epsilon$ = 0.145 (d) $\epsilon$ =0.149. Los colores representan la tensión de von Mises, rojo siendo alta tensión y azul baja tensión. Una nucleación similar es observada a temperaturas más bajas.}
\label{C3:fg:voidSeq}
\end{figure}
...
\begin{table}[htp]
\caption{Coeficientes de la regresión para tracción.}
\begin{center}
\begin{tabular}{*{4}{c}}
...
\begin{table}[htp]
\caption{Coeficientes de la regresión para compresión.}
\begin{center}
\begin{tabular}{*{4}{c}}
