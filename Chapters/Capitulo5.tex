...
La \fref{C5:fg:tip3} muestra curvas de poliedros de Voronoi versus deformación. El análisis por teselado de Voronoi es una técnica para
...
La \fref{C5:fg:tip3Comp} presenta las curvas de poliedros de Voronoi para esfuerzos de compresión. El gráfico muestra una caída en el número
...
La \fref{C5:fg:tip3Tens} muestra las curvas de poliedros de Voronoi para esfuerzos de tracción. En esta imagen, los átomos de tipo 3
