...
de cobre circonio utilizada con anterioridad (sección~\ref{S1_3}). Utilizamos nuevamente el potencial EAM (método de átomo embebido) \citep{daw84}
...
\begin{figure}[h!]
  \centering
  \begin{tabular} {c}
     \subfloat[Porosidad 3.3\% HACER ???]{
	\includegraphics[width=7.3cm]{Cap_5/spheres3.png}} \\
     \subfloat[Porosidad 5.8\% HACER ???]{
	\includegraphics[width=7.3cm]{Cap_5/spheres3.png}} \\
     \subfloat[Porosidad 13.1\%]{
	\includegraphics[width=7.3cm]{Cap_5/spheres3.png}}
  \end{tabular}
  \caption[Muestra sinterizada]{Imágenes de la muestra sinterizada.}
  \label{C5:fg:sint}
\end{figure}

Se prepararon muestras con distintas porosidades iniciales (3.3\%, 5.8\% y 13.1\%, veáse figura~\ref{C5:fg:sint}).
...
La figura~\ref{C5:fg:pzz2} \subref{C5:fg:PzzComp} grafica la presión en el eje de carga versus deformación para esfuerzos de compresión. La figura~\ref{C5:fg:stress} \subref{C5:fg:stressComp},
...
Las figuras~\ref{C5:fg:pzz2} \subref{C5:fg:PzzTens} y \ref{C5:fg:stress} \subref{C5:fg:stressTens} también muestran lo que parece ser flujo plástico: particularmente a 13\% porosidad,
...
\begin{figure}[h!]
  \centering
  \begin{tabular}{c}
    \subfloat[Porosidad 3\%, sin deformación ???]{\includegraphics[width=8cm]{Cap_5/13_0strain.png}} \\
    \subfloat[Porosidad 3\%, deformación 5\% ???]{\includegraphics[width=8cm]{Cap_5/13_5strain_comp.png}}
    \subfloat[Porosidad 3\%, deformación 12\% ???]{\includegraphics[width=8cm]{Cap_5/13_12strain_comp.png}}\\
  \end{tabular}
...
\begin{figure}[h!]
  \centering
  \begin{tabular}{c}
    \subfloat[Porosidad 6\%, sin deformación ???]{\includegraphics[width=8cm]{Cap_5/13_0strain.png}} \\
    \subfloat[Porosidad 6\%, deformación 5\% ???]{\includegraphics[width=8cm]{Cap_5/13_5strain_comp.png}}
    \subfloat[Porosidad 6\%, deformación 12\% ???]{\includegraphics[width=8cm]{Cap_5/13_12strain_comp.png}}\\
  \end{tabular}
...
\begin{figure}[h!]
  ...
  \begin{tabular}{c}
    \subfloat[Porosidad 3\%, sin deformación ???]{\includegraphics[width=8cm]{Cap_5/13_0strain.png}} \\
    \subfloat[Porosidad 3\%, deformación 6\% ???]{\includegraphics[width=8cm]{Cap_5/13_6strain_tens.png}}
    \subfloat[Porosidad 3\%, deformación 20\% ???]{\includegraphics[width=8cm]{Cap_5/13_20strain_tens.png}}\\
  \end{tabular}
...
\begin{figure}[h!]
  ...
  \begin{tabular}{c}
    \subfloat[Porosidad 6\%, sin deformación ???]{\includegraphics[width=8cm]{Cap_5/13_0strain.png}} \\
    \subfloat[Porosidad 6\%, deformación 6\% ???]{\includegraphics[width=8cm]{Cap_5/13_6strain_tens.png}}
    \subfloat[Porosidad 6\%, deformación 20\% ???]{\includegraphics[width=8cm]{Cap_5/13_20strain_tens.png}}\\
  \end{tabular}
...
\begin{figure}[h!]
  ...
  \begin{tabular}{c}
    \subfloat[Porosidad 13\%, sin deformación]{\includegraphics[width=8cm]{Cap_5/13_0strain.png}} \\
    \subfloat[Porosidad 13\%, deformación 5\%]{\includegraphics[width=8cm]{Cap_5/13_6strain_tens.png}}
    \subfloat[Porosidad 13\%, deformación 12\%]{\includegraphics[width=8cm]{Cap_5/13_20strain_tens.png}}\\
  \end{tabular}
...
La figura~\ref{C5:fg:tip3} \subref{C5:fg:tip3Comp} presenta las curvas de polyedros de Voronoi para esfuerzos de compresión. El gráfico muestra una caída en el número
...
deformación 12\%. Un endurecimiento de la muestra ocurre algunos momentos previo al cierre total de los poros, tal y como ha apreciado
\cite{yuan14} y puede verse en la figura~\ref{C5:fg:pzz2} \subref{C5:fg:PzzComp}.

La figura~\ref{C5:fg:tip3} \subref{C5:fg:tip3Tens} muestra las curvas de poledros de Voronoi para esfuerzos de tracción. En esta imágen, los átomos de tipo 3
