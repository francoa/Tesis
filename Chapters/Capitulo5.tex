...
Lo primero que debe ser considerado es que si se cortan las iteraciones de calentamiento-presión en un punto determinado y luego se realiza la relajación con las dos velocidades previamente mencionadas, las porosidades finales serán distintas. De hecho, la muestra que con una velocidad de $6.5 \cdot 10^{14} K/s$ tenía 3\% de porosidad, con $6.5 \cdot 10^{12} K/s$ no posee porosidad. Por esta razón, esta muestra se excluye en la presente sección. 

IMAGENES: SVF, temperatura, vonMises, PZZ vs. strain. ???

\begin {figure}[h!]
 \centering
  \includegraphics[width=10cm]{Cap_5/porosity_VM_strain_comp_vel12.eps}
  \caption[Tensión de von Mises vs deformación, velocidad $10^{12} K/s$.]{Tensión de von Mises vs deformación por compresión. Velocidad de enfriamiento/calentamiento de $6.5 \cdot 10^{12} K/s$}
  \label{C5:fg:sint2}
\end {figure}

\begin {figure}[h!]
 \centering
  \includegraphics[width=10cm]{Cap_5/porosity_tipe3_strain_comp_vel12.eps}
  \caption[Polyedros de Voronoi tipo 3 vs deformación, velocidad $10^{12} K/s$.]{Polyedros de Voronoi tipo 3 vs deformación por compresión. Velocidad de enfriamiento/calentamiento de $6.5 \cdot 10^{12} K/s$}
  \label{C5:fg:sint2}
\end {figure}
