...
\begin{figure}[h!]
  \centering
  \begin{tabular}{c}
    \subfloat[Porosidad 6\%, sin deformación]{\includegraphics[width=7cm]{Cap_5/porosidad_6_shearstrain04_0.png}}
    \subfloat[Porosidad 6\%, deformación 5\%]{\includegraphics[width=7cm]{Cap_5/porosidad_6_shearstrain04_006.png}} \\
    \subfloat[Porosidad 6\%, deformación 12\%]{\includegraphics[width=7cm]{Cap_5/porosidad_6_shearstrain04_012.png}}
    \subfloat[Porosidad 6\%, deformación 12\%]{\includegraphics[width=7cm]{Cap_5/porosidad_6_shearstrain04_018.png}}
  \end{tabular}
...
La figura~\ref{C5:fg:tip3Tens} muestra las curvas de poledros de Voronoi para esfuerzos de tracción. En esta imágen, los átomos de tipo 3
