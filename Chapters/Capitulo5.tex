...
de cobre circonio utilizada con anterioridad (\sref{S1_4}). Utilizamos nuevamente el potencial EAM (método de átomo embebido) \citep{daw84}
...
La \fref{C5:fg:tip3} muestra curvas de polyedros de Voronoi versus deformación. El análisis por teselado de Voronoi es una técnica para
...
La \fref{C5:fg:tip3Comp} presenta las curvas de polyedros de Voronoi para esfuerzos de compresión. El gráfico muestra una caída en el número
...
se acumula a lo largo de estas direcciones principales por el resto de la simulación, como puede observarse particularmente bien en la \fref{C5:fg:secuenciadef}. Un endurecimiento de la muestra ocurre algunos momentos previo al cierre total de los poros, tal y como ha apreciado \cite{yuan14} y puede verse en la \fref{C5:fg:PzzComp}.

La \fref{C5:fg:tip3Tens} muestra las curvas de polyedros de Voronoi para esfuerzos de tracción. En esta imagen, los átomos de tipo 3
